(* OASIS_START *)
(* DO NOT EDIT (digest: 5e1f5e7284702b281844438bdee65552) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/core";
          synopsis =
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Linux RT Library";
                      flag_default =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "rt_possible", true)
                        ]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("sexplib.unix", None);
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Core_install_printers"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\241]\165B/\232\234\205\248\249\194/6>\202\"";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
